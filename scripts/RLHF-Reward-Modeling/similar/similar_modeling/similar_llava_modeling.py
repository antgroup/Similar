...
class LlamaForRewardModelWithGating(LlamaPreTrainedModel):
    def __init__(self, config):
        ...
        self.gating = GatingNetwork(config.hidden_size, 5,
...
#
# print("Loading Model")
# config = AutoConfig.from_pretrained("/mnt/prev_nas/virtual_agent/MBC/ArmoRM/FsfairX-LLaMA3-RM-v0.1")
# similar_llava = LlamaForRewardModelWithGating(config)
# similar_llava.regression_layer.load_state_dict(torch.load("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3_checkpoint.pt", map_location=device))
# similar_llava.gating.load_state_dict(torch.load("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.pt", map_location = device))
#
# print("Saving Model")
# similar_llava.save_pretrained("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/similar/similar_llava",safe_serialization=True, torch_dtype=torch.float16, max_shard_size="4GB")