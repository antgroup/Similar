...
parser.add_argument(
    "--model_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/ArmoRM/ArmoRM-Llama3-8B-v0.1",
...
parser.add_argument(
    "--embeddings_dir",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_armo_embedding",
...
save_path = os.path.join(save_dir, "regression_armo_checkpoint.pt")
