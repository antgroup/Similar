...
rm = nn.DataParallel(rm, device_ids=[0,1,2,3])
rm = rm.to(device)
if isinstance(rm,torch.nn.DataParallel):
    rm = rm.module
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_internvl2_5_embedding_2"
