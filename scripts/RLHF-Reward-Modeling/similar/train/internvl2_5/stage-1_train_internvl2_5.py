...
parser.add_argument(
    "--embeddings_dir",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_internvl2_5_embedding_1.5",
...
save_path = os.path.join(save_dir, "regression_internvl2_5_1.5.pt")
