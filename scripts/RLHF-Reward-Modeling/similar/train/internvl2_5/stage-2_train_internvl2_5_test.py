...
parser.add_argument("--model_path", type=str, default="/mnt/prev_nas/virtual_agent/models/OpenGVLab/InternVL2_5-8B")
parser.add_argument(
...
args.embedding_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_internvl2_5_embedding-train.safetensors"
args.regression_layer_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_internvl2_5.pt"
...
embedding_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_internvl2_5_embedding-train.safetensors"
...
gating_network.load_state_dict(torch.load("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_internvl2_5.pt", map_location = device))
...
reward_bench_embeddings, reward_bench_prompt_embeddings = load_embeddings(
    "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_internvl2_5_embedding_test_modify-train.safetensors", device=device
)
