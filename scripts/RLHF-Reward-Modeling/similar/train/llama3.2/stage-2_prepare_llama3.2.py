...
parser.add_argument(
    "--dataset_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/Reward_Model_csv_zeta/Reward_Model_preference_dataset_test_prompt_simple.csv", # https://huggingface.co/datasets/RLHFlow/UltraFeedback-preference-standard
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_armo_embedding_test_prompt"
