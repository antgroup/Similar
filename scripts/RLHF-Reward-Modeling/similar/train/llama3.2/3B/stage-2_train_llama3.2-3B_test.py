...
parser.add_argument("--model_path", type=str, default="/mnt/prev_nas/virtual_agent/MBC/ArmoRM/Llama-3.2-3B-Instruct")
parser.add_argument(
...
args.embedding_path = f"/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.2-3B_embedding_train_prompt-train.safetensors"
args.regression_layer_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3.2-3B_checkpoint.pt"
...
embedding_path = f"/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.2-3B_embedding_train_prompt-train.safetensors"
...
# gating_network.load_state_dict(torch.load("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.2-3B.pt", map_location = device))
...
reward_bench_embeddings, reward_bench_prompt_embeddings = load_embeddings(
    "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.2-3B_embedding_test_prompt-train.safetensors", device=device
)
