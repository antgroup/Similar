...
parser.add_argument(
    "--dataset_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/Reward_Model_csv_zeta/Reward_Model_preference_dataset_test_prompt.csv", # https://huggingface.co/datasets/RLHFlow/UltraFeedback-preference-standard
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.2-3B_embedding_test_prompt"
...
for example in tqdm(ds, desc="Examples"):
    ...
    for iter_example in [chosen, rejected]:
        ...
        conv_formatted = tokenizer.apply_chat_template(iter_example, tokenize=False, add_generation_prompt=False).replace(tokenizer.bos_token, "")
