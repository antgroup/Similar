...
parser.add_argument(
    "--model_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/models/llm_research/Llama-3.2-3B-Instruct",
...
parser.add_argument(
    "--embeddings_dir",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3.2-3B_embedding",
...
save_path = os.path.join(save_dir, "regression_llama3.2-3B_checkpoint.pt")
