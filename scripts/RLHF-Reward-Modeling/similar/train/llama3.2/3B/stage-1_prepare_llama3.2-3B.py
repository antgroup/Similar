...
parser.add_argument(
    "--model_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/models/llm_research/Llama-3.2-3B-Instruct",  # https://huggingface.co/sfairXC/FsfairX-LLaMA3-RM-v0.1
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3.2-3B_embedding"
