...
parser.add_argument(
    "--embeddings_dir",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/checkpoints",
...
save_path = os.path.join(save_dir, "Qwen2-VL-7B-Instruct_Reward_Model.pt")
