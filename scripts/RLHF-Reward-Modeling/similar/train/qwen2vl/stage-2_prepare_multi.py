...
parser.add_argument(
    "--shard_idx", type=int, default=2, help="Index of the current shard"
)
parser.add_argument(
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_preprare"
