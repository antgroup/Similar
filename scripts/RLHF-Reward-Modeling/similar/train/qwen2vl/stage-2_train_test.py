...
def load_embeddings(embedding_path_pattern, device):
    ...
    # print("len(prompt_embeddings) = ", len(prompt_embeddings))
    # print("\n")
...
# gating_network.load_state_dict(torch.load("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_train.pt", map_location = device))
...
# save_path = f"/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_train.pt"
...
reward_bench_embeddings, reward_bench_prompt_embeddings = load_embeddings(
    "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/preference_dataset_test_plus-train.safetensors", device=device
)
