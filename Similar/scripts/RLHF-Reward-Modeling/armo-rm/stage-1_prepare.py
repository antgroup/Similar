...
parser.add_argument(
    "--model_path",
    type=str,
    default="sfairXC/FsfairX-LLaMA3-RM-v0.1",  # https://huggingface.co/sfairXC/FsfairX-LLaMA3-RM-v0.1
    help="Path to the pre-trained model (HuggingFace path or local folder)",
)
parser.add_argument(
    "--dataset_path",
    type=str,
    default="RLHFlow/ArmoRM-Multi-Objective-Data-v0.1",  # https://huggingface.co/datasets/RLHFlow/ArmoRM-Multi-Objective-Data-v0.1
...
ds = datasets.load_dataset(args.dataset_path)["train"]  # Load the training split of the dataset
