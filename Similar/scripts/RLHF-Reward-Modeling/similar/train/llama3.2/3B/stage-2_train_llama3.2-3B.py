...
parser.add_argument("--model_path", type=str, default="/mnt/prev_nas/virtual_agent/MBC/Llama-3.2-3B-Instruct")
parser.add_argument(
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.2-3B_train_prompt.pt"
