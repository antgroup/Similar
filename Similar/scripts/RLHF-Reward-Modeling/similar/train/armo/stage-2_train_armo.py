...
parser.add_argument("--model_path", type=str, default="/mnt/prev_nas/virtual_agent/MBC/ArmoRM-Llama3-8B-v0.1")
parser.add_argument(
...
parser.add_argument(
    "--preference_dataset", type=str, default="/mnt/prev_nas/virtual_agent/MBC/Reward_Model_csv_zeta/Reward_Model_preference_dataset_train_prompt_simple.csv"
)
parser.add_argument(
    "--reference_dataset",
    type=str,
...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_armo_train_prompt_1.7.pt"
