...
parser.add_argument("--model_path", type=str, default="/mnt/prev_nas/virtual_agent/MBC/ArmoRM/FsfairX-LLaMA3-RM-v0.1")
parser.add_argument(
...
args.embedding_path = f"/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3_embedding-train.safetensors"
args.regression_layer_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3_checkpoint.pt"
...
embedding_path = f"/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3_embedding-train.safetensors"
...
gating_network.load_state_dict(torch.load("/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3.pt", map_location = device))
...
#     "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3_embedding_test_modify-train.safetensors", device=device
# )
reward_bench_embeddings, reward_bench_prompt_embeddings = load_embeddings(
    "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_llama3_embedding_test_modify-train.safetensors", device=device
)
