...
parser.add_argument(
    "--model_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/ArmoRM/FsfairX-LLaMA3-RM-v0.1",
    help="Path to the pre-trained model (HuggingFace path or local folder)",
)
parser.add_argument(
    "--dataset_path",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/Reward_Model_csv_zeta/Reward_Model_multi-objective_dataset",
    help="Path to the dataset containing multi-objective labels (HuggingFace path or local folder)",
)
parser.add_argument(
    "--embeddings_dir",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3_embedding",
...
parser.add_argument(
    "--output_dir",
    type=str,
    default="/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints",
...
save_path = os.path.join(save_dir, "regression_llama3_checkpoint.pt")
...
# 训练出回归层的权重
# /mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/regression_llama3_checkpoint.pt