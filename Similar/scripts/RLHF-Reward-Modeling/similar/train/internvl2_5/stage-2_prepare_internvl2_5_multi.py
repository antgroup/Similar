...
save_path = "/mnt/prev_nas/virtual_agent/MBC/RLHF-Reward-Modeling/checkpoints/gating_network_internvl2_5_embedding_3"
    ...
    for iter_example in [chosen, rejected]:
        try:
            ...
            with torch.no_grad():
                ...
                # input_embeds = model.language_model.model.norm(input_embeds)
