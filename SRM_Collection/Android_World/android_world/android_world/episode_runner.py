...
def run_episode(
    ...
    for step_now in range(step_exist, max_n_steps):
        ...
        if termination_fn(agent.env.controller):
            ...
            status = {'result': result, 'task_successful': task_successful, 'agent_successful': agent_successful, 'success': success}
    ...
    status = {'result': result, 'task_successful': task_successful, 'agent_successful': agent_successful,
              'success': success}
