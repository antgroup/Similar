...
def process_single_image(row, results_list):
    ...
    # print("observation_trans.url = ", observation_trans.url)
    observation = observation_trans.url.replace("https", "http")
...
with concurrent.futures.ThreadPoolExecutor(max_workers=32) as executor:
    ...
    for future in tqdm(concurrent.futures.as_completed(futures), total=len(futures)):
        ...
        if len(results_list) % 10 == 0:
            ...
            df.to_csv('Benchmark_test_qwen2vl.csv', index=False, encoding='utf-8')
