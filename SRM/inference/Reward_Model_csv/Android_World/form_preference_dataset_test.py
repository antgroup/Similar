...
dataset_csv_file = "Reward_Model_Android_World_preference_dataset_test_modify.csv"
...
print("len(IP_list) = ", len(IP_list)) # 1110
# print("IP_list = ", IP_list)
print("\n")
print("len(E_list) = ", len(E_list)) # 2624
# print("E_list = ", E_list)
print("\n")
print("len(TC_list) = ", len(TC_list)) # 2624
# print("TC_list = ", TC_list)
print("\n")
print("len(TR_list) = ", len(TR_list)) # 260
# print("TR_list = ", TR_list)
print("\n")
print("len(C_list) = ", len(C_list)) # 416
# print("E_list = ", E_list)
print("\n")
print("len(all_list) = ", len(all_list)) # 1274
