...
dataset_csv_file = "Reward_Model_Android_World_preference_dataset_test_prompt.csv"
                    ...
                    try:
                        if dict[str(id)][list_now[i]][str(k + 1)]["action"] == dict[str(id)][list_now[j]][str(k + 1)]["action"]:
                            ...
                            if answer1_IP > answer2_IP:
                                IP_list.append(now)
                                chosen = get_messages(trans_type('IP'), instruction, reason_steps, observation_url,
                                                      action1)
                                rejected = get_messages(trans_type('IP'), instruction, reason_steps, observation_url,
                                                        action2)
                            ...
                            if answer1_E > answer2_E:
                                E_list.append(now)
                                chosen = get_messages(trans_type('E'), instruction, reason_steps, observation_url,
                                                      action1)
                                rejected = get_messages(trans_type('E'), instruction, reason_steps, observation_url,
                                                        action2)
                            ...
                            if answer1_TC > answer2_TC:
                                TC_list.append(now)
                                chosen = get_messages(trans_type('TC'), instruction, reason_steps, observation_url,
                                                      action1)
                                rejected = get_messages(trans_type('TC'), instruction, reason_steps, observation_url,
                                                        action2)
                            ...
                            if answer1_TR > answer2_TR:
                                TR_list.append(now)
                                chosen = get_messages(trans_type('TR'), instruction, reason_steps, observation_url,
                                                      action1)
                                rejected = get_messages(trans_type('TR'), instruction, reason_steps, observation_url,
                                                        action2)
                            ...
                            if answer1_C > answer2_C:
                                C_list.append(now)
                                chosen = get_messages(trans_type('C'), instruction, reason_steps, observation_url,
                                                      action1)
                                rejected = get_messages(trans_type('C'), instruction, reason_steps, observation_url,
                                                        action2)
                            ...
                            if answer1_total > answer2_total:
                                all_list.append(now)
                                chosen = get_messages(trans_type('total'), instruction, reason_steps, observation_url,
                                                      action1)
                                rejected = get_messages(trans_type('total'), instruction, reason_steps, observation_url,
                                                        action2)
