...
list = ["Android_World/Reward_Model_Android_World_preference_dataset_test_modify.csv", "VisualWebArena/Reward_Model_VisualWebArena_preference_dataset_test_modify.csv", "WebArena/Reward_Model_WebArena_preference_dataset_test_modify.csv"]

final_csv_file = "Reward_Model_preference_dataset_test_modify.csv"
